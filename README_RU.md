...
### Чем это грозит на практике («Эффект домино»):
```text
...
Открыт PR #17 для madmax/alpha.                        Production НЕ ТРОГАЕТСЯ!
diff: v1.1.0 -> v1.2.0                                 Прод ждет вашей отмашки в дашборде.
```

### Порядок действий инженера:
1. Заходим в открытый ботом **[PR #17 (Canary Dev Clusters)](https://github.com/xandrei-zededa/sre-versioning-sandbox/pull/17)**.
...
| **Пульт управления обновлениями** | **[Dependency Dashboard (Issue #18)](https://github.com/xandrei-zededa/sre-versioning-sandbox/issues/4)** | Интерактивно в UI |
